          ...
          $.ajax({
            ...
            .done(function(response) {
              ...
              if (response == 'success') {
                ...
                submitBtn.removeClass('wait').html('Thanks!').addClass('error');
                feedbackEl.addClass('error').html('Thanks for your message. I will contact you as soon as possible.').fadeIn(200);
                setTimeout(function() {
